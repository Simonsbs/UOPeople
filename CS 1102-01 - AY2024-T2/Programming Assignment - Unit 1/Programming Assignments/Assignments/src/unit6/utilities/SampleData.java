...
public class SampleData {
         ...
         * there are 3 types of spacecrafts: Starfighter, Shuttle, and CargoShip
         * 3 sample spacecrafts of each type are created
         * 
         * @return a list of all sample spacecrafts
         */
        public static void getAllSamples(ArrayList<Spacecraft> list) {
                list.add(new Starfighter(
                                "X-Wing",
                                "T-65",
                                "Incom 4L4 Fusial Thrust Engine",
                                true,
                                RandomDouble(),
                                "Laser Cannons",
                                true));
                list.add(new Starfighter("TIE Fighter",
                                ...
                                "Laser Cannons",
                                false));
                list.add(new Starfighter("A-Wing",
                                "RZ-1",
                                ...
                                "Laser Cannons",
                                true));
                list.add(new Shuttle("Galaxy Class",
                                "NCC-1701-D",
                                "Warp Drive",
                                true,
                                RandomDouble(),
                ...
                list.add(new Shuttle("Imperial Shuttle",
                                "Lambda-class T-4a",
                                "Cygnus Spaceworks",
                                true,
                                RandomDouble(),
                ...
                list.add(new CargoShip("Nostromo",
                                "Lockmart CM-88B Bison M-Class Starfreighter",
                                "Rolls-Royce N66 Cyclone Thrust Tunnels",
                                true,
                                RandomDouble(),
                                20000,
                                true));
                list.add(new CargoShip("Sulaco",
                                ...
                                50000,
                                true));
                list.add(new CargoShip("Valley Forge",
